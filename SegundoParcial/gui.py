...
config_file = 'configMariaDB.json'
...
ttk.Label(frame_principal, text="Directorio de Logs:").grid(row=0, column=0, sticky=tk.W)
log_directory_entry = ttk.Entry(frame_principal, width=50)
log_directory_entry.grid(row=0, column=1, sticky=(tk.W, tk.E))
ttk.Button(frame_principal, text="Cargar", command=cargar_logs).grid(row=0, column=2, sticky=tk.W)

ttk.Label(frame_principal, text="Fecha de Inicio (YYYY-MM-DD):").grid(row=1, column=0, sticky=tk.W)
fecha_inicio_entry = ttk.Entry(frame_principal, width=20)
fecha_inicio_entry.grid(row=1, column=1, sticky=(tk.W, tk.E))

ttk.Label(frame_principal, text="Fecha de Fin (YYYY-MM-DD):").grid(row=2, column=0, sticky=tk.W)
fecha_fin_entry = ttk.Entry(frame_principal, width=20)
fecha_fin_entry.grid(row=2, column=1, sticky=(tk.W, tk.E))

ttk.Label(frame_principal, text="Usuario:").grid(row=3, column=0, sticky=tk.W)
usuario_combobox = ttk.Combobox(frame_principal, state="readonly")
usuario_combobox.grid(row=3, column=1, sticky=(tk.W, tk.E))
ttk.Button(frame_principal, text="Cargar Usuarios", command=cargar_usuarios).grid(row=3, column=2, sticky=tk.W)

ttk.Label(frame_principal, text="Database:").grid(row=4, column=0, sticky=tk.W)
database_entry = ttk.Entry(frame_principal, width=50)
database_entry.grid(row=4, column=1, sticky=(tk.W, tk.E))

ttk.Label(frame_principal, text="Usuario BD:").grid(row=5, column=0, sticky=tk.W)
user_entry = ttk.Entry(frame_principal, width=50)
user_entry.grid(row=5, column=1, sticky=(tk.W, tk.E))

ttk.Label(frame_principal, text="Contraseña BD:").grid(row=6, column=0, sticky=tk.W)
password_entry = ttk.Entry(frame_principal, width=50, show='*')
password_entry.grid(row=6, column=1, sticky=(tk.W, tk.E))

ttk.Button(frame_principal, text="Guardar Configuración", command=guardar_configuracion).grid(row=7, column=1, sticky=tk.E)
ttk.Button(frame_principal, text="Generar Disparadores", command=generar_disparadores_bd).grid(row=8, column=0, sticky=tk.W)
ttk.Button(frame_principal, text="Eliminar Disparadores", command=eliminar_disparadores_bd).grid(row=8, column=1, sticky=tk.W)
ttk.Button(frame_principal, text="Generar Reporte", command=generar_reporte).grid(row=8, column=2, sticky=tk.E)
